 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_beamcirc"
 * )
 */
class ScorechartFieldBeamcirc extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_beamcirc_right' => $row->getSourceProperty('beamcirc_right'),
        'field_beamcirc_left' => $row->getSourceProperty('beamcirc_left'),
        'field_beamcirc_difference' => $row->getSourceProperty('beamcirc_difference'),
      ...
      $connection->merge('scorechart__field_beamcirc')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_beamcirc')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_beamcirc_right' => $this->t('Beamcirc Right'),
      'field_beamcirc_left' => $this->t('Beamcirc Left'),
      'field_beamcirc_difference' => $this->t('Beamcirc Difference'),
    ];
  }
