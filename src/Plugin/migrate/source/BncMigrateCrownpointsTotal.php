 ...
 *
 * @MigrateSource(
 *   id = "scorechart_crownpointstotal",
 *   source_module = "trophy"
 * )
 */
class BncMigrateCrownpointsTotal extends FieldableEntity {

  /**
   * {@inheritdoc}
   */
  public function query(): SelectInterface {
    return $this->select('field_data_crownpoints_total', 'fda')
                ->fields('fda', [
                  'entity_type',
                  'bundle',
                  'deleted',
                  ...
                  'language',
                  'delta',
                  'crownpoints_total_right',
                  'crownpoints_total_left',
                  'crownpoints_total_total',
                ]);
  }
