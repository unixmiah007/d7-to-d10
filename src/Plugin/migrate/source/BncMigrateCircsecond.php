 ...
 *
 * @MigrateSource(
 *   id = "scorechart_circsecond",
 *   source_module = "trophy"
 * )
 */
class BncMigratecircsecond extends FieldableEntity {

  /**
   * {@inheritdoc}
   */
  public function query(): SelectInterface {
    return $this->select('field_data_circsecond', 'fda')
                ->fields('fda', [
                  'entity_type',
                  'bundle',
                  'deleted',
                  ...
                  'circsecond_right',
                  'circsecond_left',
                  'circsecond_difference',
                  'circsecond_whole_loc',
                ]);
  }
