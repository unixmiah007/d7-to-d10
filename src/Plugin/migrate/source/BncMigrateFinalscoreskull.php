 ...
 * )
 */
class BncMigrateFinalscoreskull extends FieldableEntity {

  /**
   * {@inheritdoc}
   */
  public function query(): SelectInterface {
    return $this->select('field_data_finalscoreskull', 'fda')
                ->fields('fda', [
                  'entity_type',
                  'bundle',
                  'deleted',
                  ...
                  'language',
                  'delta',
                  'finalscoreskull_length',
                  'finalscoreskull_width',
                  'finalscoreskull_total',
                ]);
  }
