...
namespace Drupal\bnc_migrate\Plugin\migrate;
...
/**
 * Deriver for Scorechart based on Scorechart types.
 */
class BncScorechartDeriver extends DeriverBase implements ContainerDeriverInterface {
  ...
  /**
   * Scorechart Deriver constructor.
   *
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    $node_types = static::getSourcePlugin('bnc_migrate_scorechart_type');
    try {
    ...
    try {
      foreach ($node_types as $row) {
        ...
        $this->fieldDiscovery->addBundleFieldProcesses($migration, 'scorechart', $node_type);
