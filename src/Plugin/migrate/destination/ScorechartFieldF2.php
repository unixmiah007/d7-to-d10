 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_f2"
 * )
 */
class ScorechartFieldF2 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_f2_right' => $row->getSourceProperty('f2_right'),
        'field_f2_left' => $row->getSourceProperty('f2_left'),
        'field_f2_difference' => $row->getSourceProperty('f2_difference'),
      ];
      ...
      $connection->merge('scorechart__field_f2')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_f2')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_f2_right' => $this->t('f2 Right'),
      'field_f2_left' => $this->t('f2 Left'),
      'field_f2_difference' => $this->t('f2 Difference'),
    ];
  }
