 ...
 * )
 */
class ScorechartFieldG6 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $connection->merge('scorechart__field_g6')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g6')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g6_right' => $this->t('g6 Right'),
      'field_g6_left' => $this->t('g6 Left'),
      'field_g6_difference' => $this->t('g6 Difference'),
    ];
  }
