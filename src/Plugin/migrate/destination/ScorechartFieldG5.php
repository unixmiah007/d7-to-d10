 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g5"
 * )
 */
class ScorechartFieldG5 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g5_right' => $row->getSourceProperty('g5_right'),
        'field_g5_left' => $row->getSourceProperty('g5_left'),
        'field_g5_difference' => $row->getSourceProperty('g5_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g5')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g5')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g5_right' => $this->t('g5 Right'),
      'field_g5_left' => $this->t('g5 Left'),
      'field_g5_difference' => $this->t('g5 Difference'),
    ];
  }
