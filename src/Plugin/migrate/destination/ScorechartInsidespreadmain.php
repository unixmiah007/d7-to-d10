 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_insidespreadmain"
 * )
 */
class ScorechartInsidespreadmain extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_insidespreadmain_value' => $row->getSourceProperty('insidespreadmain_value')
      ];
      ...
      $connection->merge('scorechart__field_insidespreadmain')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_insidespreadmain')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_insidespreadmain_value' => $this->t('insidespreadmain value')
    ];
  }
