 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_crownpointstotal"
 * )
 */
class ScorechartFieldCrownpointsTotal extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_crownpoints_total_right' => $row->getSourceProperty('crownpoints_total_right'),
        'field_crownpoints_total_left' => $row->getSourceProperty('crownpoints_total_left'),
        'field_crownpoints_total_total' => $row->getSourceProperty('crownpoints_total_total'),
      ];
      ...
      $connection->merge('scorechart__field_crownpoints_total')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_crownpoints_total')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_crownpoints_total_right' => $this->t('crownpointstotal Right'),
      'field_crownpoints_total_left' => $this->t('crownpointstotal Left'),
      'field_crownpoints_total_total' => $this->t('crownpointstotal Total'),
    ];
  }
