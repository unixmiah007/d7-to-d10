 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_hasplug"
 * )
 */
class ScorechartHasplug extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_has_plug_value' => $row->getSourceProperty('sheep_hasplug_value')
      ];
      ...
      $connection->merge('scorechart__field_has_plug')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_has_plug')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_has_plug_value' => $this->t('hasplug value')
    ];
  }
