 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_abnormalpoints"
 * )
 */
class ScorechartFieldAbnormalPoints extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_abnormalpoints_right' => $row->getSourceProperty('abnormalpoints_right'),
        'field_abnormalpoints_left' => $row->getSourceProperty('abnormalpoints_left'),
      ];
      ...
      $connection->merge('scorechart__field_abnormalpoints')
        ->key([
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_abnormalpoints_right' => $this->t('Abnormal Points Right'),
