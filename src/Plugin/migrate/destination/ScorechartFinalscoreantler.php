 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_finalscoreantler"
 * )
 */
class ScorechartFinalscoreantler extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_finalscoreantler_abnormals' => $row->getSourceProperty('finalscoreantler_abnormals'),
        'field_finalscoreantler_gross' => $row->getSourceProperty('finalscoreantler_gross'),
        'field_finalscoreantler_spread' => $row->getSourceProperty('finalscoreantler_spread'),
        'field_finalscoreantler_right' => $row->getSourceProperty('finalscoreantler_right'),
        'field_finalscoreantler_left' => $row->getSourceProperty('finalscoreantler_left'),
        'field_finalscoreantler_crown' => $row->getSourceProperty('finalscoreantler_crown'),
        'field_finalscoreantler_difference' => $row->getSourceProperty('finalscoreantler_difference'),
        'field_finalscoreantler_subtotal' => $row->getSourceProperty('finalscoreantler_subtotal'),
        'field_finalscoreantler_subtotal2' => $row->getSourceProperty('finalscoreantler_subtotal2'),
        'field_finalscoreantler_total' => $row->getSourceProperty('finalscoreantler_total'),
      ];
      ...
      $connection->merge('scorechart__field_finalscoreantler')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_finalscoreantler')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_finalscoreantler_abnormals' => $this->t('Abnormals'),
      'field_finalscoreantler_gross' => $this->t('Gross'),
      'field_finalscoreantler_spread' => $this->t('Spread'),
      'field_finalscoreantler_right' => $this->t('Right'),
      'field_finalscoreantler_left' => $this->t('Left'),
      'field_finalscoreantler_crown' => $this->t('Crown'),
      'field_finalscoreantler_difference' => $this->t('Difference'),
      'field_finalscoreantler_subtotal' => $this->t('Subtotal'),
      'field_finalscoreantler_subtotal2' => $this->t('Subtotal2'),
      'field_finalscoreantler_total' => $this->t('Total'),
    ];
  }
