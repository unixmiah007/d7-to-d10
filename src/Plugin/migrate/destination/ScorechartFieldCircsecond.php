 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_circsecond"
 * )
 */
class ScorechartFieldcircsecond extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_circsecond_right' => $row->getSourceProperty('circsecond_right'),
        'field_circsecond_left' => $row->getSourceProperty('circsecond_left'),
        'field_circsecond_difference' => $row->getSourceProperty('circsecond_difference'),
        'field_circsecond_loc' => $row->getSourceProperty('circsecond_whole_loc'),
      ];
      ...
      $connection->merge('scorechart__field_circsecond')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_circsecond')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_circsecond_right' => $this->t('circsecond Right'),
      'field_circsecond_left' => $this->t('circsecond Left'),
      'field_circsecond_difference' => $this->t('circsecond Difference'),
      'field_circsecond_loc' => $this->t('circsecond Location'),
    ];
  }
