 ...
 * )
 */
class ScorechartFinalscorehornandtusk extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $connection->merge('scorechart__field_finalscorehornandtusk')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_finalscorehornandtusk')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_finalscorehornandtusk_right' => $this->t('Right'),
      'field_finalscorehornandtusk_left' => $this->t('Left'),
      'field_finalscorehornandtusk_gross' => $this->t('Gross'),
      'field_finalscorehornandtusk_difference' => $this->t('Difference'),
      'field_finalscorehornandtusk_subtotal' => $this->t('Subtotal'),
      'field_finalscorehornandtusk_total' => $this->t('Total'),
    ];
  }
