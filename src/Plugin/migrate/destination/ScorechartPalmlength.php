 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_palmlength"
 * )
 */
class ScorechartPalmlength extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_palmlength_right' => $row->getSourceProperty('palmlength_right'),
        'field_palmlength_left' => $row->getSourceProperty('palmlength_left'),  
        'field_palmlength_difference' => $row->getSourceProperty('palmlength_difference'),
      ];
      ...
      $connection->merge('scorechart__field_palmlength')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_palmlength')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_palmlength_right' => $this->t('palmlength Right'),
      'field_palmlength_left' => $this->t('palmlength Left'),
      'field_palmlength_difference' => $this->t('palmlength difference'),
    ];
  }
