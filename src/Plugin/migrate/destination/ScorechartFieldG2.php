 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g2"
 * )
 */
class ScorechartFieldG2 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g2_right' => $row->getSourceProperty('g2_right'),
        'field_g2_left' => $row->getSourceProperty('g2_left'),
        'field_g2_difference' => $row->getSourceProperty('g2_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g2')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g2')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g2_right' => $this->t('g2 Right'),
      'field_g2_left' => $this->t('g2 Left'),
      'field_g2_difference' => $this->t('g2 Difference'),
    ];
  }
