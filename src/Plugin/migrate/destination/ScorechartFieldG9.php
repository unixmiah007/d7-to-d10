 ...
 * )
 */
class ScorechartFieldG9 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $connection->merge('scorechart__field_g9')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g9')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g9_right' => $this->t('g9 Right'),
      'field_g9_left' => $this->t('g9 Left'),
      'field_g9_difference' => $this->t('g9 Difference'),
    ];
  }
