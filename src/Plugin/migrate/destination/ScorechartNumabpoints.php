 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_numabpoints"
 * )
 */
class ScorechartNumabpoints extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_numabpoints_right' => $row->getSourceProperty('numabpoints_right'),
        'field_numabpoints_left' => $row->getSourceProperty('numabpoints_left'),  
        'field_numabpoints_total' => $row->getSourceProperty('numabpoints_total'),
      ];
      ...
      $connection->merge('scorechart__field_numabpoints')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_numabpoints')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_numabpoints_right' => $this->t('numabpoints Right'),
      'field_numabpoints_left' => $this->t('numabpoints Left'),
      'field_numabpoints_total' => $this->t('numabpoints total'),
    ];
  }
