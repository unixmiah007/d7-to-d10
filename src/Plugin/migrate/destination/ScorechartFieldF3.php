 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_f3"
 * )
 */
class ScorechartFieldF3 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_f3_right' => $row->getSourceProperty('f3_right'),
        'field_f3_left' => $row->getSourceProperty('f3_left'),
        'field_f3_difference' => $row->getSourceProperty('f3_difference'),
      ];
      ...
      $connection->merge('scorechart__field_f3')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_f3')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_f3_right' => $this->t('f3 Right'),
      'field_f3_left' => $this->t('f3 Left'),
      'field_f3_difference' => $this->t('f3 Difference'),
    ];
  }
