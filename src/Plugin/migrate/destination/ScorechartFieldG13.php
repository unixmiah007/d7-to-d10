 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g13"
 * )
 */
class ScorechartFieldG13 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g13_right' => $row->getSourceProperty('g13_right'),
        'field_g13_left' => $row->getSourceProperty('g13_left'),
        'field_g13_difference' => $row->getSourceProperty('g13_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g13')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g13')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g13_right' => $this->t('g13 Right'),
      'field_g13_left' => $this->t('g13 Left'),
      'field_g13_difference' => $this->t('g13 Difference'),
    ];
  }
