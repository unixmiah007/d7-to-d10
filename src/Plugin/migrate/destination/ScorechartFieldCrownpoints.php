 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_crownpoints"
 * )
 */
class ScorechartFieldCrownpoints extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_crownpoints_right' => $row->getSourceProperty('crownpoints_right'),
        'field_crownpoints_left' => $row->getSourceProperty('crownpoints_left'),
      ];
      ...
      $connection->merge('scorechart__field_crownpoints')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_crownpoints')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_crownpoints_right' => $this->t('crownpoints Right'),
      'field_crownpoints_left' => $this->t('crownpoints Left'),
    ];
  }
