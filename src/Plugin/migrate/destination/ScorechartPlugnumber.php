 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_plugnumber"
 * )
 */
class ScorechartPlugnumber extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_plug_number_value' => $row->getSourceProperty('sheep_plugnum_value')
      ];
      ...
      $connection->merge('scorechart__field_plug_number')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_plugnumber')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_plug_number_value' => $this->t('Plugnumber value')
    ];
  }
