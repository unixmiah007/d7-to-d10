 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g14"
 * )
 */
class ScorechartFieldG14 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g14_right' => $row->getSourceProperty('g14_right'),
        'field_g14_left' => $row->getSourceProperty('g14_left'),
        'field_g14_difference' => $row->getSourceProperty('g14_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g14')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g14')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g14_right' => $this->t('g14 Right'),
      'field_g14_left' => $this->t('g14 Left'),
      'field_g14_difference' => $this->t('g14 Difference'),
    ];
  }
