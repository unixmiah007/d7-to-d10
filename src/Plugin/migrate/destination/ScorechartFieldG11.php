 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g11"
 * )
 */
class ScorechartFieldG11 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g11_right' => $row->getSourceProperty('g11_right'),
        'field_g11_left' => $row->getSourceProperty('g11_left'),
        'field_g11_difference' => $row->getSourceProperty('g11_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g11')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g11')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g11_right' => $this->t('g11 Right'),
      'field_g11_left' => $this->t('g11 Left'),
      'field_g11_difference' => $this->t('g11 Difference'),
    ];
  }
