 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_palmwidth"
 * )
 */
class ScorechartPalmwidth extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_palmwidth_right' => $row->getSourceProperty('palmwidth_right'),
        'field_palmwidth_left' => $row->getSourceProperty('palmwidth_left'),  
        'field_palmwidth_difference' => $row->getSourceProperty('palmwidth_difference'),
      ];
      ...
      $connection->merge('scorechart__field_palmwidth')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_palmwidth')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_palmwidth_right' => $this->t('palmwidth Right'),
      'field_palmwidth_left' => $this->t('palmwidth Left'),
      'field_palmwidth_difference' => $this->t('palmwidth difference'),
    ];
  }
