 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g7"
 * )
 */
class ScorechartFieldG7 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g7_right' => $row->getSourceProperty('g7_right'),
        'field_g7_left' => $row->getSourceProperty('g7_left'),
        'field_g7_difference' => $row->getSourceProperty('g7_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g7')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g7')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g7_right' => $this->t('g7 Right'),
      'field_g7_left' => $this->t('g7 Left'),
      'field_g7_difference' => $this->t('g7 Difference'),
    ];
  }
