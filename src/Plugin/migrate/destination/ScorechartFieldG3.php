 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g3"
 * )
 */
class ScorechartFieldG3 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g3_right' => $row->getSourceProperty('g3_right'),
        'field_g3_left' => $row->getSourceProperty('g3_left'),
        'field_g3_difference' => $row->getSourceProperty('g3_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g3')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g3')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g3_right' => $this->t('g3 Right'),
      'field_g3_left' => $this->t('g3 Left'),
      'field_g3_difference' => $this->t('g3 Difference'),
    ];
  }
