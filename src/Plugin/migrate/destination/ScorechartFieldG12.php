 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g12"
 * )
 */
class ScorechartFieldG12 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g12_right' => $row->getSourceProperty('g12_right'),
        'field_g12_left' => $row->getSourceProperty('g12_left'),
        'field_g12_difference' => $row->getSourceProperty('g12_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g12')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g12')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g12_right' => $this->t('g12 Right'),
      'field_g12_left' => $this->t('g12 Left'),
      'field_g12_difference' => $this->t('g12 Difference'),
    ];
  }
