 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g15"
 * )
 */
class ScorechartFieldG15 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g15_right' => $row->getSourceProperty('g15_right'),
        'field_g15_left' => $row->getSourceProperty('g15_left'),
        'field_g15_difference' => $row->getSourceProperty('g15_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g15')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g15')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g15_right' => $this->t('g15 Right'),
      'field_g15_left' => $this->t('g15 Left'),
      'field_g15_difference' => $this->t('g15 Difference'),
    ];
  }
