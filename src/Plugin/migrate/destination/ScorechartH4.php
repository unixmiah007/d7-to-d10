 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_h4"
 * )
 */
class ScorechartH4 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_h4_right' => $row->getSourceProperty('h4_right'),
        'field_h4_left' => $row->getSourceProperty('h4_left'),
        'field_h4_difference' => $row->getSourceProperty('h4_difference'),
      ];
      ...
      $connection->merge('scorechart__field_h4')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_h4')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_h4_right' => $this->t('h4 Right'),
      'field_h4_left' => $this->t('h4 Left'),
      'field_h4_diffrence' => $this->t('h4 Difference'),
    ];
  }
