 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_greatestlength"
 * )
 */
class ScorechartGreatestlength extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_greatestlength_value' => $row->getSourceProperty('greatestlength_value'),
      ];
      ...
      $connection->merge('scorechart__field_greatestlength')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_greatestlength')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_greatestlength_value' => $this->t('Length'),
    ];
  }
