 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_f1"
 * )
 */
class ScorechartFieldF1 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_f1_right' => $row->getSourceProperty('f1_right'),
        'field_f1_left' => $row->getSourceProperty('f1_left'),
        'field_f1_difference' => $row->getSourceProperty('f1_difference'),
      ];
      ...
      $connection->merge('scorechart__field_f1')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_f1')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_f1_right' => $this->t('f1 Right'),
      'field_f1_left' => $this->t('f1 Left'),
      'field_f1_difference' => $this->t('f1 Difference'),
    ];
  }
