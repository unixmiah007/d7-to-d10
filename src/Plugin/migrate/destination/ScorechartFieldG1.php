 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g1"
 * )
 */
class ScorechartFieldG1 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g1_right' => $row->getSourceProperty('g1_right'),
        'field_g1_left' => $row->getSourceProperty('g1_left'),
        'field_g1_difference' => $row->getSourceProperty('g1_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g1')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g1')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g1_right' => $this->t('g1 Right'),
      'field_g1_left' => $this->t('g1 Left'),
      'field_g1_difference' => $this->t('g1 Difference'),
    ];
  }
