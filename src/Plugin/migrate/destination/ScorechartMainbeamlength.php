 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_mainbeamlength"
 * )
 */
class ScorechartMainbeamlength extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_mainbeamlength_right' => $row->getSourceProperty('mainbeamlength_right'),
        'field_mainbeamlength_left' => $row->getSourceProperty('mainbeamlength_left'),  
        'field_mainbeamlength_difference' => $row->getSourceProperty('mainbeamlength_difference'),
      ];
      ...
      $connection->merge('scorechart__field_mainbeamlength')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_mainbeamlength')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_mainbeamlength_right' => $this->t('mainbeamlength Right'),
      'field_mainbeamlength_left' => $this->t('mainbeamlength Left'),
      'field_mainbeamlength_difference' => $this->t('mainbeamlength Difference'),
    ];
  }
