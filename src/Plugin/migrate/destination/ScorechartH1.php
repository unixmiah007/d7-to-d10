 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_h1"
 * )
 */
class ScorechartH1 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_h1_right' => $row->getSourceProperty('h1_right'),
        'field_h1_left' => $row->getSourceProperty('h1_left'),
        'field_h1_difference' => $row->getSourceProperty('h1_difference'),
      ];
      ...
      $connection->merge('scorechart__field_h1')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_h1')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_h1_right' => $this->t('H1 Right'),
      'field_h1_left' => $this->t('H1 Left'),
      'field_h1_diffrence' => $this->t('H1 Difference'),
    ];
  }
