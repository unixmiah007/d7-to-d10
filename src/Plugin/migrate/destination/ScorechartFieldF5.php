 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_f5"
 * )
 */
class ScorechartFieldF5 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_f5_right' => $row->getSourceProperty('f5_right'),
        'field_f5_left' => $row->getSourceProperty('f5_left'),
        'field_f5_difference' => $row->getSourceProperty('f5_difference'),
      ];
      ...
      $connection->merge('scorechart__field_f5')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_f5')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_f5_right' => $this->t('f5 Right'),
      'field_f5_left' => $this->t('f5 Left'),
      'field_f5_difference' => $this->t('f5 Difference'),
    ];
  }
