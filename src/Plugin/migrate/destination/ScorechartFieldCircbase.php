 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_circbase"
 * )
 */
class ScorechartFieldCircbase extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_circbase_right' => $row->getSourceProperty('circbase_right'),
        'field_circbase_left' => $row->getSourceProperty('circbase_left'),
        'field_circbase_difference' => $row->getSourceProperty('circbase_difference')
      ];
      ...
      $connection->merge('scorechart__field_circbase')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_circbase')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_circbase_right' => $this->t('Circbase Right'),
      'field_circbase_left' => $this->t('Circbase Left'),
      'field_circbase_difference' => $this->t('Circbase Difference')
    ];
  }
