 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_h2"
 * )
 */
class Scorecharth2 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_h2_right' => $row->getSourceProperty('h2_right'),
        'field_h2_left' => $row->getSourceProperty('h2_left'),
        'field_h2_difference' => $row->getSourceProperty('h2_difference'),
      ];
      ...
      $connection->merge('scorechart__field_h2')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_h2')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_h2_right' => $this->t('h2 Right'),
      'field_h2_left' => $this->t('h2 Left'),
      'field_h2_diffrence' => $this->t('h2 Difference'),
    ];
  }
