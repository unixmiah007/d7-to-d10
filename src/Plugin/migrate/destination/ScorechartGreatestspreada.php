 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_greatestspreada"
 * )
 */
class ScorechartGreatestspreada extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_greatestspreada_value' => $row->getSourceProperty('greatestspreada_value'),
      ];
      ...
      $connection->merge('scorechart__field_greatestspreada')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_greatestspreada')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_greatestspreada_value' => $this->t('Length'),
    ];
  }
