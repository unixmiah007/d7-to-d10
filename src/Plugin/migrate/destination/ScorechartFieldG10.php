 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g10"
 * )
 */
class ScorechartFieldG10 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g10_right' => $row->getSourceProperty('g10_right'),
        'field_g10_left' => $row->getSourceProperty('g10_left'),
        'field_g10_difference' => $row->getSourceProperty('g10_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g10')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g10')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g10_right' => $this->t('g10 Right'),
      'field_g10_left' => $this->t('g10 Left'),
      'field_g10_difference' => $this->t('g10 Difference'),
    ];
  }
