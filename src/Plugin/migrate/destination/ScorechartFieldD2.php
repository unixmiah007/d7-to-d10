 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_d2"
 * )
 */
class ScorechartFieldD2 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_d2_right' => $row->getSourceProperty('d2_right'),
        'field_d2_left' => $row->getSourceProperty('d2_left'),
      ];
      ...
      $connection->merge('scorechart__field_d2')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_d2')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_d2_right' => $this->t('d2 Right'),
      'field_d2_left' => $this->t('d2 Left'),
    ];
  }
