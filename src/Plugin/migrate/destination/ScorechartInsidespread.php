 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_insidespread"
 * )
 */
class ScorechartInsidespread extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_insidespread_value' => $row->getSourceProperty('insidespread_value')
      ];
      ...
      $connection->merge('scorechart__field_insidespread')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_insidespread')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_insidespread_value' => $this->t('Insidespread value')
    ];
  }
