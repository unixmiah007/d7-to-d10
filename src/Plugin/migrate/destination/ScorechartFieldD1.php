 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_d1"
 * )
 */
class ScorechartFieldD1 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_d1_right' => $row->getSourceProperty('d1_right'),
        'field_d1_left' => $row->getSourceProperty('d1_left'),
        'field_d1_difference' => $row->getSourceProperty('d1_difference'),
      ];
      ...
      $connection->merge('scorechart__field_d1')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_d1')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_d1_right' => $this->t('D1 Right'),
      'field_d1_left' => $this->t('D1 Left'),
      'field_d1_differe ce' => $this->t('D1 Difference'),
    ];
  }
