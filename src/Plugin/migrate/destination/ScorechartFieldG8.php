 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g8"
 * )
 */
class ScorechartFieldG8 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g8_right' => $row->getSourceProperty('g8_right'),
        'field_g8_left' => $row->getSourceProperty('g8_left'),
        'field_g8_difference' => $row->getSourceProperty('g8_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g8')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g8')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g8_right' => $this->t('g8 Right'),
      'field_g8_left' => $this->t('g8 Left'),
      'field_g8_difference' => $this->t('g8 Difference'),
    ];
  }
