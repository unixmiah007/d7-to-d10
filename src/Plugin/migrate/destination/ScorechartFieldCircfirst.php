 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_circfirst"
 * )
 */
class ScorechartFieldCircfirst extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $connection->merge('scorechart__field_circfirst')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_circfirst')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_circfirst_right' => $this->t('circfirst Right'),
      'field_circfirst_left' => $this->t('circfirst Left'),
      'field_circfirst_difference' => $this->t('circfirst Difference')
    ];
  }
