 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_finalscoreskull"
 * )
 */
class ScorechartFinalscoreskull extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_finalscoreskull_length' => $row->getSourceProperty('finalscoreskull_length'),
        'field_finalscoreskull_width' => $row->getSourceProperty('finalscoreskull_width'),
        'field_finalscoreskull_total' => $row->getSourceProperty('finalscoreskull_total'),
      ];
      ...
      $connection->merge('scorechart__field_finalscoreskull')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_finalscoreskull')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_finalscoreskull_length' => $this->t('Length'),
      'field_finalscoreskull_width' => $this->t('Width'),
      'field_finalscoreskull_total' => $this->t('Total'),
    ];
  }
