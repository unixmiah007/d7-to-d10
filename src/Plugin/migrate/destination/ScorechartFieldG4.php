 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_g4"
 * )
 */
class ScorechartFieldG4 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_g4_right' => $row->getSourceProperty('g4_right'),
        'field_g4_left' => $row->getSourceProperty('g4_left'),
        'field_g4_difference' => $row->getSourceProperty('g4_difference'),
      ];
      ...
      $connection->merge('scorechart__field_g4')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_g4')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_g4_right' => $this->t('g4 Right'),
      'field_g4_left' => $this->t('g4 Left'),
      'field_g4_difference' => $this->t('g4 Difference'),
    ];
  }
