 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_circthird"
 * )
 */
class ScorechartFieldCircthird extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_circthird_right' => $row->getSourceProperty('circthird_right'),
        'field_circthird_left' => $row->getSourceProperty('circthird_left'),
        'field_circthird_difference' => $row->getSourceProperty('circthird_difference'),
        'field_circthird_loc' => $row->getSourceProperty('circthird_whole_loc'),
      ];
      ...
      $connection->merge('scorechart__field_circthird')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_circthird')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_circthird_right' => $this->t('circthird Right'),
      'field_circthird_left' => $this->t('circthird Left'),
      'field_circthird_difference' => $this->t('circthird Difference'),
      'field_circthird_loc' => $this->t('circthird Location'),
    ];
  }
