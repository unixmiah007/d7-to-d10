 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_f4"
 * )
 */
class ScorechartFieldF4 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_f4_right' => $row->getSourceProperty('f4_right'),
        'field_f4_left' => $row->getSourceProperty('f4_left'),
        'field_f4_difference' => $row->getSourceProperty('f4_difference'),
      ];
      ...
      $connection->merge('scorechart__field_f4')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_f4')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_f4_right' => $this->t('f4 Right'),
      'field_f4_left' => $this->t('f4 Left'),
      'field_f4_difference' => $this->t('f4 Difference'),
    ];
  }
