 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_greatestspreadht"
 * )
 */
class ScorechartGreatestspreadht extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_greatestspreadht_value' => $row->getSourceProperty('greatestspreadht_value'),
      ];
      ...
      $connection->merge('scorechart__field_greatestspreadht')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_greatestspreadht')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_greatestspreadht_value' => $this->t('Length'),
    ];
  }
