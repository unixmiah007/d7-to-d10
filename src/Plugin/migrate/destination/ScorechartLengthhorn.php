 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_lengthhorn"
 * )
 */
class ScorechartLengthhorn extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_lengthhorn_right' => $row->getSourceProperty('lengthhorn_right'),
        'field_lengthhorn_left' => $row->getSourceProperty('lengthhorn_left'),  
        'field_lengthhorn_difference' => $row->getSourceProperty('lengthhorn_difference'),
      ];
      ...
      $connection->merge('scorechart__field_lengthhorn')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_lengthhorn')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_lengthhorn_right' => $this->t('Lengthhorn Right'),
      'field_lengthhorn_left' => $this->t('Lengthhorn Left'),
      'field_lengthhorn_difference' => $this->t('Lengthhorn Difference'),
    ];
  }
