 ...
 * )
 */
class ScorechartH3 extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $connection->merge('scorechart__field_h3')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_h3')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_h3_right' => $this->t('h3 Right'),
      'field_h3_left' => $this->t('h3 Left'),
      'field_h3_diffrence' => $this->t('h3 Difference'),
    ];
  }
