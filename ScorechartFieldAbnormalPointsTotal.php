 ...
 *
 * @MigrateDestination(
 *   id = "scorechart_field_abnormalpointstotal"
 * )
 */
class ScorechartFieldAbnormalPointsTotal extends DestinationBase {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    try {
      ...
      $data = [
        ...
        'field_abnormalpoints_total_right' => $row->getSourceProperty('abnormalpoints_total_right'),
        'field_abnormalpoints_total_left' => $row->getSourceProperty('abnormalpoints_total_left'),
        'field_abnormalpoints_total_total' => $row->getSourceProperty('abnormalpoints_total_total'),
      ];
      ...
      $connection->merge('scorechart__field_abnormalpoints_total')
        ->key([
  ...
  public function rollback(array $destination_identifier) {
    try {
      ...
      $connection = \Drupal::database();
      $connection->delete('scorechart__field_abnormalpoints')
  ...
  public function fields() {
    ...
    return [
      ...
      'delta' => $this->t('Delta'),
      'field_abnormalpoints_total_right' => $this->t('Abnormal Points Right'),
      'field_abnormalpoints_left' => $this->t('Abnormal Points Left'),
      'field_abnormalpoints_total_total' => $this->t('Abnormal Points Left'),
    ];
  }
